...
while True:
    ...
    if instructions:
        ...
        # Rules
        rules = [
            "Play a minesweeper game yourself by:",
            "- clicking on a cell to reveal it",
            "- right-clicking on a cell to mark it as a mine",
            "- and marking all mines successfully to win!",
            "",
